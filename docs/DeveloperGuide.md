...
| `* *`    | tutor                                      | store both student and parent contact detials under the same entry   | reach the right person depending on context                |
...
| `*`      | tutor | attach notes or commnets to each student           | keep track oflearning progress and special requests
| `*`      | tutor | reminded whenever i have an upcoming session           | plan for it and not be late                                            |
