    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_ADDRESS,
                        PREFIX_ROLE, PREFIX_TAG, PREFIX_REMARK, PREFIX_PARENT);
        ...
        if (argMultimap.getValue(PREFIX_PARENT).isPresent()) {
            editPersonDescriptor.setParentName(ParserUtil.parseName(argMultimap.getValue(PREFIX_PARENT).get()));
        }
