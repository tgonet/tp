...
public class TypicalPersons {
    ...
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("94824421")
            .withAddress("4th street, Fifth Avenue, Singapore").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("84824243")
            .withAddress("little india, Downtown Line, SMRT, Singapore").build();
    ...
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withAddress(VALID_ADDRESS_BOB).withTags(VALID_TAG_PARENT, VALID_TAG_STUDENT)
            .build();
